...
class Test_PIM:
    ...
    def test_TC_PIM_10(self, booting_function):
        ...
        try:
            ...
            time.sleep(3)
            self.driver.find_element(by=By.XPATH, value=data.Suman_Selectors.employee_termination_xpath).click()
            time.sleep(4)
            self.driver.find_element(by=By.XPATH, value=data.Suman_Selectors.termination_date_xpath).send_keys(data.Suman_Data.termination_date)
            self.driver.find_element(by=By.XPATH, value=data.Suman_Selectors.termination_reason_xpath).click()
            time.sleep(3)
            self.driver.find_element(by=By.XPATH, value=data.Suman_Selectors.termination_save_xpath).click()
