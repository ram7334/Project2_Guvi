...
class Test_PIM:
    ...
    def test_TC_PIM_03(self, booting_function):
        ...
        time.sleep(3)
        self.driver.find_element(by=By.XPATH, value=data.Suman_Selectors.add_employee_xpath).click()
        time.sleep(5)
        self.driver.find_element(by=By.XPATH, value=data.Suman_Selectors.create_login_xpath).click()
        time.sleep(3)
        self.driver.find_element(by=By.XPATH, value=data.Suman_Selectors.new_username_xpath).send_keys(data.Suman_Data.new_username)
        self.driver.find_element(by=By.XPATH, value=data.Suman_Selectors.new_password_xpath).send_keys(data.Suman_Data.new_password)
        self.driver.find_element(by=By.XPATH, value=data.Suman_Selectors.conf_new_password_xpath).send_keys(data.Suman_Data.conf_new_password)
        time.sleep(3)
        self.driver.find_element(by=By.XPATH, value=data.Suman_Selectors.statusradio_xpath).click()
        ...
        print("SUCCESSFUL #USER LOGIN DETAIL IS CCREATED")
